...
public class HashicorpCertificateResolverTest {
  ...
  private static final JcaX509CertificateConverter JCA_X509_CERTIFICATE_CONVERTER = new JcaX509CertificateConverter().setProvider(PROVIDER);
  ...
  public X509Certificate generateCertificate(int validity, String cn) throws CertificateException, OperatorCreationException, IOException, NoSuchAlgorithmException, NoSuchProviderException {
